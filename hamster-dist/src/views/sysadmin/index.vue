<template>
    <div class="index">
        ...
        <div class="page-list">
            <div class="li f-s" @click="$router.push(`/sysadmin/userInformation?uid=${props.uid}&lang=${lang}&ticket=${props.ticket}`)">
                <div class="left f">
            ...
            <div class="li f-s" @click="$router.push(`/sysadmin/banList?uid=${props.uid}&lang=${lang}&ticket=${props.ticket}`)">
                <div class="left f">
        ...
        <div class="page-list">
            <div class="li f-s" @click="$router.push(`/sysadmin/roomInformation?uid=${props.uid}&lang=${lang}&ticket=${props.ticket}`)">
                <div class="left f">
        ...
        <div class="page-list">
            ...
            <div class="li f-s" @click="$router.push(`/sysadmin/dataBD?uid=${props.uid}&lang=${lang}&ticket=${props.ticket}`)">
                <div class="left f">
