<template>
    <div class="index">
        ...
        <div class="page-list">
            <div class="li f-s"
                @click="$router.push(`/sysadmin/userInformation?uid=${props.uid}&lang=${lang}&ticket=${props.ticket}`)">
                <div class="left f">
            ...
            <div class="li f-s"
                @click="$router.push(`/sysadmin/banList?uid=${props.uid}&lang=${lang}&ticket=${props.ticket}`)">
                <div class="left f">
            ...
            <div class="li f-s" @click="showGiftPage = true">
                <div class="left f">
                    <img src="@/assets/img/sysadmin/icon-free.png" alt="">
                    <span>{{ $t('sysadmin.free') }}</span>
                </div>
                <img class="go" src="@/assets/img/sysadmin/icon-right.png" alt="">
            </div>
        </div>
        ...
        <div class="page-list">
            <div class="li f-s"
                @click="$router.push(`/sysadmin/roomInformation?uid=${props.uid}&lang=${lang}&ticket=${props.ticket}`)">
                <div class="left f">
        ...
        <div class="page-list">
            ...
            <div class="li f-s"
                @click="$router.push(`/sysadmin/dataBD?uid=${props.uid}&lang=${lang}&ticket=${props.ticket}`)">
                <div class="left f">
        ...
        <van-popup v-model:show="showCreateBD" position="bottom" round class="showCreateBD">
            <createBD :isUid="props.uid" :ticket="props.ticket" @success="handleCreateBDSuccess"
                @close="handleCreateBDClose"></createBD>
        </van-popup>

        <van-popup v-model:show="showGiftPage" position="bottom" round class="showGiftPage">
            <giftPage :isUid="props.uid" :ticket="props.ticket" @success="handleCreateBDSuccess"
                @close="handleCreateBDClose"></giftPage>
        </van-popup>
    </div>
