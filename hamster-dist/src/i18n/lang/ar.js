...
const AR = {
  ...
  guild: {
    ...
    monthlyData: "البيانات الأسبوعية",
    ...
    label: {
      ...
      thisMonthHours: "ساعات هذا الأسبوع",
      thisMonthDays: "أيام هذا الأسبوع",
      lastMonthIncome: "دخل الأسبوع الماضي",
      lastMonthHours: "ساعات الأسبوع الماضي",
      lastMonthDays: "أيام الأسبوع الماضي",
    },
    unit: {
      date: "التاريخ",
      days: "أيام .",
  ...
  transfer: {
    ...
    min: "الحد الأدنى",
    attention:
      "سيتم تحويل العملات إلى حساب Hamster Live، لا يمكنك إلغاءه بعد إتمام المعاملة، يرجى التأكد من التحويل إلى الحساب الصحيح.",
