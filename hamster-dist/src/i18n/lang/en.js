...
const EN = {
  ...
  sysadmin: {
    ...
    Host: 'Host',
    Use: 'User Management',
    Use1: 'User information',
    Use2: 'User ban list',
    Wel: 'Welcome gift pack',
    Roo: 'Room Management',
    Roo3: 'Room information',
    BDM: 'BD Management',
    Cre: 'Create BD',
    BDd: 'BD data',
    Ent: 'Enter the user ID',
    Sea: 'Search',
    Edit: 'Edit',
    Ban: 'Ban',
    Gen: 'Gender',
    ...
    Cha4: 'Change name',
    Cha5: 'Change Bio',
    Cha6: 'Change the user avatar to the default avatar',
    Cha7: 'Change user name to default name',
    Del: 'Delete personalized signature',
    Ban8: 'Ban time',
    day: '1 day',
    day9: '7 day',
    day10: '30 day',
    For: 'Forever',
    Rea: 'Reason for ban',
    Ple: 'Please enter the reason for the ban',
    Ban11: 'Ban this User',
    Are: 'Are you sure you want to ban this user?',
    Can: 'Cancel',
    Con: 'Confirm',
    Ban12: 'Banned',
    View: 'View',
    Unb: 'Unblocked',
    Ban13: 'Ban information',
    Ban14: 'Ban time:',
    Unb15: 'Unblock this user',
    The: 'The user has been unblocked',
    Whe: 'Whether to confirm the unblocking of this user?',
    Ent16: 'Enter the Room ID',
    Owner: 'Owner',
    Adm17: 'Administrator',
    Mem: 'Member',
    Cha18: 'Change the room avatar to the default avatar.',
    Cha19: 'Change room name to default name',
    Ple20: 'Please check the user ID',
    Sea21: 'Search user ID',
    Wha: 'WhatsApp',
    Ple22: 'Please enter the WhatsApp',
    Tot: 'Total agency',
    New: 'New agency',
    Age23: 'Agency income',
    Cre24: 'Creation time',
